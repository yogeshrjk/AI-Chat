...
export default function Login() {
      ...
      if (loading) {
        return (
          <div className="fixed inset-0 bg-white/20 backdrop-blur-sm bg-opacity-50 flex items-center justify-center z-50">
            <BotMessageSquare className="w-15 h-15" />
          </div>
        );
      }
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-white/80 dark:bg-[rgb(35,35,35)] relative">
      ...
      <div className="flex rounded-2xl shadow-lg max-w-3xl p-5 items-center bg-white dark:bg-[#111] ">
        <div className="md:w-1/2 p-5 md:px-12">
          <div className="flex flex-col gap-2 justify-center items-center text-black dark:text-white">
            <BotMessageSquare className="w-10 h-10" />
            <span className="font-bold text-2xl text-[rgb(35,35,35)] dark:text-white text-center">
              AI-Chat
            </span>
          </div>
          <form action="" className="flex flex-col gap-2 mt-6">
            <div className="relative w-full">
              <span className="absolute inset-y-0 left-2 top-5 flex items-center text-gray-500 dark:text-white">
                <Mail className="w-4 h-4 text-[rgb(35,35,35)] dark:text-white" />
              </span>
              <input
                className="pl-8 p-2 mt-5 w-full rounded-md text-sm text-black dark:text-white border border-black dark:border-white focus:border-black-500 outline-none"
                type="email"
                placeholder="Email"
                required
                value={email}
            ...
            <div className="relative w-full">
              <span className="absolute inset-y-0 left-2 top-2 flex items-center text-gray-500 dark:text-white">
                <LockKeyhole className="w-4 h-4 text-[rgb(35,35,35)] dark:text-white" />
              </span>
              <input
                className="p-2 mt-2 pl-8 rounded-md text-sm text-black dark:text-white border border-black dark:border-white w-full focus:border-black-500 outline-none"
              ...
              <svg
                ...
                } absolute top-5 right-3 cursor-pointer`}
                width="16"
                height="16"
                fill="grey"
                viewBox="0 0 16 16"
            ...
            <button
              ...
              className="py-2 mt-2 rounded-md border border-none text-sm text-[#ffffff] text-center bg-[rgb(35,35,35)] hover:scale-105 duration-110"
            >
              Login
            </button>
            {error && (
          ...
          <div className="mt-2 text-xs border-b border-[rgb(35,35,35)] dark:border-gray-400 py-4 text-[rgb(35,35,35)] dark:text-white">
            <a href="#">
              <p className="text-[rgb(35,35,35)] dark:text-white">
          ...
          <div className="mt-3 text-xs flex justify-between items-center text-[rgb(35,35,35)] dark:text-white">
            ...
            <Link
              to="/signup"
              className="py-2 px-6 bg-[rgb(35,35,35)] text-white text-xs text-center ml-2 rounded-md hover:scale-110 duration-200"
            >
